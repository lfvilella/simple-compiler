	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					if (ch == 'd') {AddCh(); state = 3; break;}
					else {state = 0; break;}
				case 3:
					{t.kind = 1; break loop;}
				case 4:
					if (ch == 'p') {AddCh(); state = 5; break;}
					else {state = 0; break;}
				case 5:
					if (ch == 'p') {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
				...
				case 8:
					{t.kind = 2; break loop;}
				case 9:
					if (ch == 'r') {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
					if (ch == 'a') {AddCh(); state = 11; break;}
					else {state = 0; break;}
				case 11:
					if (ch == 'n') {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
					if (ch == 'g') {AddCh(); state = 13; break;}
					else {state = 0; break;}
				case 13:
					if (ch == 'e') {AddCh(); state = 14; break;}
					else {state = 0; break;}
				case 14:
					{t.kind = 3; break loop;}
